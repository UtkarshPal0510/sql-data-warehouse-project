...
Script Purpose:
    ...
    - Cleans, standardizes, and transforms data from bronze tables into silver tables.
    - Logs loading progress and duration.
===============================================================================
*/
...
INSERT INTO silver.crm_prd_info (
    ...
    prd_end_dt
     ...
     SELECT 
      ...
      DATEADD(day, -1, LEAD(prd_start_dt) OVER (PARTITION BY prd_key ORDER BY prd_start_dt)) AS prd_end_dt-- calculate the end date as one date before the start date  
...
--erp_PX_CAT__G1V2
SET @start_time=GETDATE();
PRINT'>>Truncating Table silver.erp_PX_CAT__G1V2' 
